...
function draw_tree(error, treeData) {
    ...
    function sortTree() {
        /*tree.sort(function(a, b) {
            return b.name.toLowerCase() < a.name.toLowerCase() ? 1 : -1;  // Function for sorting the tree nodes alphabetically
        });*/                                                        // Removed by Radiela for obtaining full control over the BT hierarchy
    }
    ...
    baseSvg.append("rect")
        .attr("width", "100%")
        .attr("height", "80%")
        .attr("fill", "black")  // Edited Radiela
    ...
    function changeColor(d){    // Added by Radiela for changing color of nodes

        //result = (d.children || d._children) ? "rgb(95, 5, 89)" : "lime";
        //rgb(149, 8, 123), rgb(168, 19, 141), rgb(222, 60, 192)
        result = (d.children || d._children) ? "rgb(222, 60, 192)" : "lime";
    ...
    function update(source) {
        ...
        nodeEnter.append("circle")
            ...
            .attr("r", 0)
            .style("stroke", "#43c59e");  // Added by Radiela for changing the color of the circle line
        ...
        node.select("circle.nodeCircle")
            .attr("r", 4.5)
            .style("fill", changeColor);  // Added by Radiela for changing the circle fill
        ...
        link.transition()
            .duration(duration)
            .attr("d", diagonal)
            //.style("stroke", "#9b7874");   // Added by Radiela for changing the color of the links
            //.style("stroke", "rgb(28, 6, 102)"); //darkblue
            .style("stroke", "rgb(5, 95, 91)");  // best so far
        ...
        //added by jim for 'save as' functionality
        ...
        var newTree = JSON.parse(myRoot);
        newTree= JSON.stringify(newTree, getCircularReplacer(true)); //Stringify a second time to delete the propeties you don't need
        //console.log(newTree); //JSON in newTree

        //Store the updated tree (added by Radiela)
        sessionStorage.setItem("newTree", newTree);
